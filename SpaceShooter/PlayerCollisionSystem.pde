class PlayerCollisionSystem
{
    ...
    PlayerCollisionSystem(Player player, ArrayList<Asteroid> asteroids, Game.Stats stats)
    {
        this.player = player;
    ...
    public void checkCollisions()
    {
        ...
        for(Asteroid asteroid : asteroids)
        {
            ...
            {   
                ...
                //as we are colliding, we are going to delete all the asteroids on screen to 
                //give the player a moment to respawn
                asteroids.clear();
